function comenzar(pokemon){
    ...
    if (localStorage.getItem("total"+ pokemon)) {
        localStorage.setItem("total" + pokemon, totalValoraciones)
    }else{
        localStorage.setItem("total" + pokemon, 0);
    }
